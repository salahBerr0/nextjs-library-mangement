        ...
        <form onSubmit={handleLogin} className="w-full space-y-5" noValidate>
            <div>
              ...
              <div className="relative">
                  ...
                  <input type="email" placeholder="Enter your email address" value={loginFormData.email} onChange={(e) => setLoginFormData(prev => ({...prev, email: e.target.value}))} className="w-full bg-gray-50/80 h-12 pl-10 pr-4 py-3 rounded-xl text-gray-900 placeholder:text-gray-500 border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200" required/>            
              </div>
            </div>
            <div>
