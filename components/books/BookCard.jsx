  ...
  return (
    <>
      {!isExpanded ? (
        ...
        // Expanded View - Always centered in viewport
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-fade-in overflow-y-auto" onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp}>
          <div
            ref={modalRef}
            className={`bg-white rounded-3xl p-6 w-full max-w-4xl mx-auto shadow-2xl border border-gray-100 animate-scale-in modal-content ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`}
            style={{
